...
-- 3. Insertamos Platos
-- Columnas: nombre, descripcion, tipo, categoria, pais, precio, variante, cantidad, is_deleted, premium

-- ===================== ESPAÑOL =====================
INSERT INTO PLATOS (nombre, descripcion, tipo, categoria, pais, precio, variante, cantidad, is_deleted, premium) VALUES
-- Entrantes
